...
/**
 * Esta clase encapsula los datos que devuelve como respuesta una petición POST
 * de subida de imagenes a través del servicio imgur.
 * 
 * @see <a href=
 *      "https://api.imgur.com/3/image">https://api.imgur.com/3/image</a>
 * @author luismi
 *
 */
